...
func TestLambdaCodesPath(t *testing.T) {
	...
	assert.Equal(t, LambdaCodesPath, "./aws/TEMPLATE/lib/lambda-handler/index.py")
}
func TestRequirementsTxtPath(t *testing.T) {
	//TODO: Please check the variable name and value according to your requirement
	assert.Equal(t, RequirementsTxtPath, "./aws/TEMPLATE/lambda_layer_lib/requirements.txt")
}
func TestAwsCdkVenvActivatePath(t *testing.T) {
	//TODO: Please check the variable name and value according to your requirement
	assert.Equal(t, AwsCdkVenvActivatePath, "./aws/TEMPLATE/.venv/bin/activate")
}
